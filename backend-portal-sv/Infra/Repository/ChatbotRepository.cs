...
namespace Infra.Repository
{
    public class ChatbotRepository : IChatbotRepository
    {
        ...
        public readonly string _modelName;
        ...
        public ChatbotRepository(IConfiguration configuration, ConnectionContext context, IStorageHandler storageHandler)
        {
            ...
            _temperature = ParseFloat(configuration["HuggingFace:Temperature"] ?? throw new ArgumentNullException("HuggingFace:Temperature"));
            _maxTokens = int.Parse(configuration["HuggingFace:MaxTokens"] ?? throw new ArgumentNullException("HuggingFace:MaxTokens"));
            _topP = ParseFloat(configuration["HuggingFace:TopP"] ?? throw new ArgumentNullException("HuggingFace:TopP"));
        ...
        public async Task<string> SendMessageAsync(string userMessage)
        {
            ...
            var payload = CreateRequestPayload(prompt);
        ...
        public object CreateRequestPayload(string prompt)
        {
            return new
            {
                model = _modelName,
        ...
        public static StringContent SerializePayload(object payload)
        {
        ...
        public async Task<string> HandleResponseAsync(HttpResponseMessage response)
        {
            ...
            throw new HttpResponseException(response.StatusCode, $"Erro na resposta: {response.StatusCode} - {errorDetails}");
        }
        ...
        {
            var prompt =  CreateCategoryPrompt(resumoConversa);
            var payload = CreateRequestPayload(prompt);
        ...
        public static string CreateCategoryPrompt(string contexto)
        {
